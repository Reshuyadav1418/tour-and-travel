    ...
    <Slider {...settings}>
      <div className="testimonial py-4 px-3">
        <p>
          ...
          mollitia accusantium, libero, amet modi nam nihil nesciunt odit ipsum
          laborum recusandae iste, tenetur voluptatibus?
        </p>
      ...
      <div className="testimonial py-4 px-3">
        ...
        <div className="d-flex align-items-center gap-4 mt-3">
          <img src={ava03} className="w-25 h-25 rounded-2" alt="Mark Wilson" />
          <div>
